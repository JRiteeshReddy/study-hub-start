...
const Chapter = () => {
  ...
  // For now, we'll use localStorage to track completed chapters
  // Later this will be replaced with Supabase
  ...
  const handleMarkComplete = () => {
    ...
    if (!updated.includes(currentChapter)) {
      updated.push(currentChapter);
    ...
    if (currentChapter < 5) {
      ...
      // Finished all chapters, mark course as complete and go back to home
